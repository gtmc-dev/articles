...
<div class="scheduled-ticks-comparison" style="display: flex; align-items:flex-start;">
    <!-- 图片 -->
...
@media (max-width: 1200px) {
    .scheduled-ticks-comparison {
        display: block !important;
    }
    .scheduled-ticks-comparison img {
        margin-bottom: 15px;
    }
    .scheduled-ticks-comparison table {
        width: 100%;
    }
}
</style>
...
The Scheduled Ticks of the entire world are actually controlled by a **World Tick Scheduler** during execution. The Scheduled Ticks at each position are controlled by a **Chunk Tick Scheduler** of the corresponding chunk when being added and stored.[^8]

[^8]: **World Tick Scheduler** and **Chunk Tick Scheduler** are terms directly copied from class name in yarn mapping.
