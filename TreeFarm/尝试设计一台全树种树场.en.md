...
Oak trees can randomly grow into **large oaks** (_commonly called drumstick trees_), so we need to height-limit them to prevent this. The height-limiting block goes at **the 9th block above the dirt**.
