...
The main sources of **NC updates** in tree farms are **TT (Tile Tick) components** (typically Redstone Repeaters, Comparators, and Observers), **Redstone Dust**, **powered or activated rails** _\*we'll just call these "rails" from here on, since tree farms rarely involve the other two types\*_, **Pistons** along with the blocks they push/pull, and **Note Blocks**.
