...
> 2. The explanation of `QC` here is incorrect. For details, see GTMC Update Theory [1.3.2 Properties of NC Updates, QC Activation, BUD Devices](https://techmc.wiki/articles/block-update/update-concepts) 
