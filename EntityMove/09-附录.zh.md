---
slug: entity-motion-appendix
title: 附录
description: 常见实体运动属性、完整公式、研究环境与辅助工具、主要符号及单位、定义索引
index: 9
is-advanced: false
---
...
| 实体                                                               | 重力/($m/gt^2$)  | 速度乘数（k值）                                   | 高度/m                                                               | 宽度/m                                                     | 眼部高度/m                                                               | 运算顺序[^table-a-4] |
| ------------------------------------------------------------------ | ---------------- | ------------------------------------------------- | -------------------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------ | -------------------- |
| TNT                                                                | 0.04             | 0.98                                              | 0.98                                                                 | 0.98                                                       | 0.15                                                                     | GMD                  |
| 下落的方块                                                         | 0.04             | 0.98                                              | 0.98                                                                 | 0.98                                                       | 0.833                                                                    | GMD                  |
| 空中的物品                                                         | 0.04             | 0.98[^table-a-1]                                  | 0.25                                                                 | 0.25                                                       | 0.2125                                                                   | GMD                  |
| 空中的经验球                                                       | 0.03             | 0.98[^table-a-2]                                  | 0.5                                                                  | 0.5                                                        | 0.425                                                                    | GMD                  |
| 空中的船                                                           | 0.04             | 水平0.9，Y轴1                                     | 0.5625                                                               | 1.375                                                      | 0.5625                                                                   | GDM                  |
| 空中的矿车                                                         | 0.04             | 0.95                                              | 0.7                                                                  | 0.98                                                       | 0.595                                                                    | GMD                  |
| 空中的箭矢/三叉戟                                                  | 0.05[^table-a-3] | 0.99[^table-a-3]                                  | 0.5                                                                  | 0.5                                                        | 0.13                                                                     | MDG                  |
| 空中的雪球/鸡蛋/末影珍珠                                           | 0.03[^table-a-3] | 0.99[^table-a-3][^table-a-6]                      | 0.25                                                                 | 0.25                                                       | 0.2125                                                                   | MDG[^table-a-5]      |
| 空中的药水瓶                                                       | 0.05[^table-a-3] | 0.99[^table-a-3][^table-a-6]                      | 0.25                                                                 | 0.25                                                       | 0.2125                                                                   | MDG[^table-a-5]      |
| 空中的附魔之瓶                                                     | 0.07[^table-a-3] | 0.99[^table-a-3][^table-a-6]                      | 0.25                                                                 | 0.25                                                       | 0.2125                                                                   | MDG[^table-a-5]      |
| 空中的恶魂和末影龙火球                                             | 0                | 0.95[^table-a-3]                                  | 1                                                                    | 1                                                          | 0.85                                                                     | MAD                  |
| 空中的烈焰人火球/普通凋零之首                                      | 0                | 0.95[^table-a-3]                                  | 0.3125                                                               | 0.3125                                                     | 0.265625                                                                 | MAD                  |
| 空中的鱼竿浮标                                                     | 0.03             | 0.92                                              | 0.25                                                                 | 0.25                                                       | 0.2125                                                                   | GMD                  |
| 空中的蓝色凋零之首                                                 | 0                | 0.73[^table-a-3]                                  | 0.3125                                                               | 0.3125                                                     | 0.265625                                                                 | MAD                  |
| 空中的羊驼唾沫                                                     | 0.06[^table-a-3] | 0.99[^table-a-3]                                  | 0.25                                                                 | 0.25                                                       | 0.2125                                                                   | MDG                  |
| 无有效目标的潜影贝导弹                                             | 0.04             | 1                                                 | 0.3125                                                               | 0.3125                                                     | 0.265625                                                                 | GM                   |
| 空中或地面上的玩家（除体积和眼部高度外也适用于大部分生物和盔甲架） | 0.08             | 水平0.91[^table-a-3]，Y轴0.98[^table-a-3]         | 站立时1.8，睡觉和濒死时0.2，鞘翅飞行和游泳和激流飞行时0.6，潜行时1.5 | 站立、潜行、鞘翅飞行和游泳和激流飞行时0.6，睡觉和濒死时0.2 | 睡觉时为0.2，游泳、鞘翅飞行和激流飞行时为0.4，潜行时为1.27，站立时为1.62 | MGD                  |
| 水中的玩家（除体积和眼部高度外也适用于大部分生物和盔甲架）         | 0.005            | 水平取决于深海探索者等级，Y轴0.8[^table-a-3] 同上 | 同上                                                                 | 同上                                                       | 同上                                                                     | MDG                  |
| 较深熔岩中的玩家（除体积和眼部高度外也适用于大部分生物和盔甲架）   | 0.005            | 0.5                                               | 同上                                                                 | 同上                                                       | 同上                                                                     | 同上                 |

[^table-a-1]: 如需高精度计算水平运动，建议X、Z轴上使用这里给出的数值的单精度浮点真实值，可在表2.5中找到

[^table-a-2]: 如需高精度计算竖直运动，建议Y轴上使用这里给出的数值的单精度浮点真实值，可在表2.5中找到

[^table-a-3]: 如需高精度计算竖直运动，建议使用这里给出的数值的单精度浮点真实值，部分可在表2.5中找到

[^table-a-4]: 以实体只受重力和一般阻力时为准，其他情况下可以参考6.1节或第7节。

[^table-a-5]: 1.21.2之后为GDM

[^table-a-6]: 1.20.5之后改为双精度浮点数存储
