...
banner:
  src: ./img/Updates.jpg
  alt: Illegal-state blocks missing updates
...
The behaviors listed above that _do not emit **NC Updates**_ are typical cases that emit **PP Updates** but not **NC Updates**. Similarly, **BUD devices** cannot detect **PP Updates**.
