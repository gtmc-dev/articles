...
This process of exploring the cavern is the update process, where <NC>"placing torches"</NC> corresponds to emitting NC updates (pushing onto the stack), and <PP>picking up torches</PP> corresponds to emitting PP updates (popping from the stack). As for what this "stack" means, you can refer to [Appendix - Terminology Explanation → Stack and Call Stack](../Appendix/01-栈.md), and this update method is depth-first search (DFS).
