...
:hidden[Sticky piston returns to complete state, nothing else happens]
...
:hidden[Regular block is removed]
...
:hidden[Front piston becomes headless piston, back piston returns to normal piston]
...
:hidden[Redstone block disappears, leftmost sticky piston drops block]
...
Unfortunately, if you try to replicate the layout and activation sequence of _**5.10.1 Breaking Bedrock**_
