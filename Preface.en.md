...
Original content in this documentation is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh-hans).

Minecraft ® is a registered trademark of Mojang AB.
Minecraft © Mojang AB / Microsoft Corporation. All Rights Reserved.

Game screenshots, textures, source code, and other content referenced in this documentation are protected by copyright law and are quoted in a limited manner in compliance with the [Minecraft EULA](https://www.minecraft.net/zh-hans/eula) and [Minecraft Usage Guidelines](https://www.minecraft.net/zh-hans/usage-guidelines).

The source code referenced in this documentation comes from decompilation research of Minecraft, using the [Yarn mappings](https://github.com/FabricMC/yarn) for readable decompilation. These mappings are licensed under [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/deed.zh-hans).
