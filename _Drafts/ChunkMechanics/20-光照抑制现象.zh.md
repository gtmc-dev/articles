...
```java file=net/minecraft/server/world/ServerLightingProvider.java lines=195-217
...
```java file=net/minecraft/server/world/ServerLightingProvider.java lines=131-137
...
```java file=net/minecraft/server/world/ChunkTaskPrioritySystem.java lines=49-53
...
```java file=net/minecraft/server/world/ChunkTaskPrioritySystem.java lines=124-130
...
```java file=net/minecraft/server/world/LevelPrioritizedQueue.java lines=18-22
...
```java file=net/minecraft/server/world/LevelPrioritizedQueue.java lines=82-100
...
```java file=net/minecraft/server/world/ServerChunkManager.java lines=383-397
...
```java file=net/minecraft/server/MinecraftServer.java lines=513-521
...
```java file=net/minecraft/server/world/LevelPrioritizedQueue.java lines=49-51
...
```java file=net/minecraft/server/world/ServerLightingProvider.java lines=132-136
this.pendingTasks.add(Pair.of(stage, task));
if (this.pendingTasks.size() >= 1000) {
    this.runTasks();
}
